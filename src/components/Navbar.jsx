...
const Navbar = () => {
  ...
  return (
    ...
    <Fragment>
      <nav className=' w-full fixed top-0 left-0 bg-white z-10'>
        <div className="container">
            <div className="navbar w-full h-[80px] pl-[40px] pr-[40px] flex items-center justify-between">
                ...
                <div className=' flex gap-9 '>
                    ...
                    <p className='decoration-dashed uppercase'><span className=' inline-block text-[#5B5CE2]'>User :</span> {username.name}</p>
                    </div>
                   <form>
